...
export function UpdateAvailableModal({
	...
	const useTranslateModal = (
		...
		raw?: boolean,
	) => useTranslateModals(`update_available.${key}`, ctx, raw);
	...
	return (
		<Box>
			...
			<Group grow justify="space-between" mt={"md"}>
				...
				>
					{is_manual
						? useTranslateModal("buttons.download_manual")
				...
				<Button
					...
					onClick={async () => {
						open(
							`https://github.com/Kenya-DK/quantframe-react/releases/tag/v${updater?.version || new_version}`,
						);
					}}
				>
