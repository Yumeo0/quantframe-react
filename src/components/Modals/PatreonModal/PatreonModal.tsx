...
const PatreonClientId =
	"6uDrK7uhMBAidiAvzQd7ukmHFz4NUXO1wocruae24C4_04rXrUMSvCzC9RKbQpmN"; // Replace with your actual Patreon Client ID
...
export function PatreonModal({
	innerProps: { user, is_dev },
}: ContextModalProps<PatreonModalProps>) {
	// Translate general
	const useTranslate = (
		key: string,
			...
			>
				...
				<Group gap="md" className={classes.headerGroup}>
					<ThemeIcon
						...
						variant="gradient"
						gradient={{ from: "#ff424d", to: "#ff7b54", deg: 45 }}
					>
