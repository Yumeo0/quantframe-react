...
import type { RivenAttribute as RivenAttributeType, TauriTypes } from "$types";
...
export function RivenAttribute({ value }: RivenAttributeProps) {
	...
	const attributeDisplayName =
		nameMap[value.url_name] || value.effect || value.url_name;
				...
				components={{
					num_color_tag: (
						<Text
							...
							c={
								value.positive
									? "var(--qf-positive-color)"
									: "var(--qf-negative-color)"
							}
						/>
					),
				}}
