...
import { Container, type PaperProps, Tabs } from "@mantine/core";
	...
	const tabs = [
		{
			...
			component: (
				<LiveTradingPanel
					...
					onSubmit={(v) => onSubmit({ ...value, live_scraper: v })}
				/>
			),
			id: "live_scraper",
		},
		...
		},
		{
			...
			component: (
				<NotificationsPanel
					...
					onSubmit={(v) => onSubmit({ ...value, notifications: v })}
				/>
			),
			id: "notifications",
		},
		{
			...
			component: (
				<AdvancedPanel
					value={value.advanced_settings}
					onSubmit={(v) => onSubmit({ ...value, advanced_settings: v })}
				/>
			),
			id: "advanced",
		},
		{
			...
			component: (
				<SummaryPanel
					...
					onSubmit={(v) => onSubmit({ ...value, summary_settings: v })}
				/>
			),
			id: "summary",
		},
		{
			...
			component: (
				<HttpServerPanel
					value={value.http_server}
					onSubmit={(v) => onSubmit({ ...value, http_server: v })}
				/>
			),
			id: "http_server",
		},
