...
export class OrderModule {
	...
	async getPagination(
		query: WFMarketTypes.WfmOrderControllerGetListParams,
	): Promise<WFMarketTypes.WfmOrderControllerGetListData> {
		return await this.client.sendInvoke<WFMarketTypes.WfmOrderControllerGetListData>(
			"get_wfm_orders_pagination",
			{ query },
		);
	}
	...
	async getById(id: string): Promise<WFMarketTypes.OrderDetails> {
		return await this.client.sendInvoke<WFMarketTypes.OrderDetails>(
			"get_wfm_order_by_id",
			{ id },
		);
	}
