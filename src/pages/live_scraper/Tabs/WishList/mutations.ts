...
export const useWishListMutations = ({
	...
	const exportMutation = createGenericMutation(
		{
			mutationFn: (data: TauriTypes.WishListControllerGetListParams) =>
				api.wish_list.exportJson(data),
	...
	const createMutation = createGenericMutation(
		{
			mutationFn: (data: TauriTypes.CreateWishListItem) =>
				api.wish_list.create(data),
	...
	const updateMutation = createGenericMutation(
		{
			mutationFn: (data: TauriTypes.UpdateWishListItem) =>
				api.wish_list.update(data),
			successKey: "update_wish_list",
			errorKey: "update_wish_list",
			getLoadingId: (variables: TauriTypes.UpdateWishListItem) =>
				`${variables.id}`,
			getSuccessMessage: (data: any) => ({ name: data.item_name }),
		},
		hooks,
	...
	const updateMultipleMutation = createGenericMutation(
		{
			...
			}) => api.wish_list.updateMultiple(data.ids, data.input),
			successKey: "update_wish_list",
			errorKey: "update_wish_list",
	...
	const boughtMutation = createGenericMutation(
		{
			mutationFn: (data: TauriTypes.BoughtWishListItem) =>
				api.wish_list.bought(data),
			successKey: "bought_wish_list",
			errorKey: "bought_wish_list",
			getLoadingId: (variables: TauriTypes.BoughtWishListItem) =>
				`${variables.id}`,
			getSuccessMessage: (data: any) => ({ name: data.item_name }),
		},
		hooks,
