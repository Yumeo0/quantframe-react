...
const BarChartFooter = ({
	...
	i18nKey: string;
	statistics: TauriTypes.FinancialReport;
}) => {
	const useTranslate = (
		key: string,
		context?: { [key: string]: any },
		i18Key?: boolean,
	) => useTranslatePages(`home.${key}`, { ...context }, i18Key);
	const useTranslateTooltips = (
		key: string,
		context?: { [key: string]: any },
		i18Key?: boolean,
	...
	return (
		<Stack gap={"xs"}>
			<TextTranslate
				...
				values={{
					expense: statistics?.expenses || 0,
					revenue: statistics?.revenue || 0,
					profit: statistics?.total_profit || 0,
				}}
			...
			<TextTranslate
				...
				values={{
					...
					trades:
						(statistics?.sale_count || 0) + (statistics?.purchases_count || 0),
				}}
				components={ExtraComponents}
			/>
		</Stack>
...
export default function HomePage() {
	...
	const useTranslateCards = (
		key: string,
		context?: { [key: string]: any },
		i18Key?: boolean,
	) => useTranslate(`cards.${key}`, { ...context }, i18Key);
						...
						footer={
							<TextTranslate
								...
								values={{
									...
									profit_margin: (
										summary?.today.summary.profit_margin || 0
									).toFixed(2),
								}}
							/>
						}
						...
						footer={
							<TextTranslate
								...
								values={{
									...
									profit_margin: (
										summary?.best_seller.profit_margin || 0
									).toFixed(2),
								}}
							/>
						}
			...
			<Grid>
				<Grid.Col span={4}>
					<BarCardChart
						...
						chartStyle={{
							background: theme.other.chartStyles.total.bgColor,
							height: "200px",
						}}
						datasets={[
							{
								...
								backgroundColor:
									theme.other.chartStyles.total.currentYearLineColor,
							},
							{
								label: useTranslateCards("total.bar_chart.datasets.last_year"),
								data: summary?.total.last_year.chart.values || [],
								backgroundColor:
									theme.other.chartStyles.total.lastYearLineColor,
							},
						]}
						context={
							<BarChartFooter
								i18nKey={useTranslateCards(
									"total.bar_chart.footers",
									undefined,
									true,
								)}
				...
				<Grid.Col span={4}>
					<BarCardChart
						...
						chartStyle={{
							background: theme.other.chartStyles.today.bgColor,
							height: "200px",
						}}
						datasets={[
							{
						...
						context={
							<BarChartFooter
								i18nKey={useTranslateCards(
									"today.bar_chart.footers",
									undefined,
									true,
								)}
								statistics={
									summary?.today.summary as TauriTypes.FinancialReport
								}
							/>
						}
					/>
				...
				<Grid.Col span={4}>
					<BarCardChart
						title={useTranslateCards("recent_days.bar_chart.title", {
							days: (summary?.recent_days.chart.labels.length || 1) - 1 || 0,
						})}
						labels={summary?.recent_days.chart.labels || []}
						chartStyle={{
							background: theme.other.chartStyles.lastDays.bgColor,
							height: "200px",
						}}
						datasets={[
							{
								label: useTranslateCards(
									"recent_days.bar_chart.datasets.profit",
								),
						...
						context={
							<BarChartFooter
								i18nKey={useTranslateCards(
									"recent_days.bar_chart.footers",
									undefined,
									true,
								)}
								statistics={
									summary?.recent_days.summary as TauriTypes.FinancialReport
								}
							/>
						}
					/>
						...
						<Group p={10} justify="space-between">
							...
							<Group>
								<ColorInfo
									...
									text={useTranslateCards(
										"last_transaction.info_box.purchase",
										{ count: summary?.total.purchases_count || 0 },
									)}
								/>
								<ColorInfo
									infoProps={{
									...
									text={useTranslateCards("last_transaction.info_box.sale", {
										count: summary?.total.sale_count || 0,
									})}
								/>
							</Group>
						</Group>
				...
				<Grid.Col span={6}>
					<DataTable
						...
						columns={[
							{
								accessor: "name",
								title: useTranslateCards(
									"best_seller.by_category.datatable.columns.name",
								),
								width: "150px",
								render: ({ properties }) => (
									<Box
							...
							},
							{
								accessor: "revenue",
								title: useTranslateCards(
									"best_seller.by_category.datatable.columns.revenue",
								),
								render: ({ revenue }) => (
									<NumberFormatter
										thousandSeparator="."
							...
							},
							{
								accessor: "expense",
								title: useTranslateCards(
									"best_seller.by_category.datatable.columns.expense",
								),
								render: ({ expenses }) => (
									<NumberFormatter
										thousandSeparator="."
							...
							},
							{
								accessor: "profit",
								title: useTranslateCards(
									"best_seller.by_category.datatable.columns.profit",
								),
								render: ({ total_profit }) => (
									<NumberFormatter
										style={
											{
												color:
													total_profit > 0
														? theme.other.positiveColor
														: theme.other.negativeColor,
							...
							},
							{
								...
								title: useTranslateCards(
									"best_seller.by_category.datatable.columns.profit_margin",
								),
								render: ({ profit_margin }) => (
									<NumberFormatter
										decimalScale={2}
										suffix=" %"
										value={profit_margin}
