...
type LoggingPanelProps = Record<string, never>;
export const LoggingPanel = (_: LoggingPanelProps) => {
		...
		<Box>
			...
			<DataTable
				...
				columns={[
					{
						accessor: "command",
						title: useTranslateDataGridColumns("command"),
					},
						...
						render: (record) => (
							<ActionWithTooltip
								tooltip={useTranslateDataGridColumns(
									"actions.buttons.remove_tooltip",
								)}
								icon={faTrash}
								color="red"
								onClick={async (e) => {
