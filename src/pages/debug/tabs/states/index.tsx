...
type StatesPanelProps = Record<string, never>;
export const StatesPanel = (_: StatesPanelProps) => {
	const { app_info, app_error, alerts, settings } = useAppContext();
	const { user } = useAuthContext();

	// Translate general
	const useTranslateTabLogging = (
		key: string,
	...
	// State's
	const [tauriEvents, setTauriEvents] = useState<
	...
	return (
		<Accordion>
			<Accordion.Item value="app_info">
				<Accordion.Control>
					{useTranslateDataGridColumns("app_info")}
				</Accordion.Control>
				<Accordion.Panel>
					<JsonInput
			...
			<Accordion.Item value="app_error">
				<Accordion.Control>
					{useTranslateDataGridColumns("app_error")}
				</Accordion.Control>
				<Accordion.Panel>
					<JsonInput
			...
			<Accordion.Item value="alerts">
				<Accordion.Control>
					{useTranslateDataGridColumns("alerts")}
				</Accordion.Control>
				<Accordion.Panel>
					<JsonInput
			...
			<Accordion.Item value="settings">
				<Accordion.Control>
					{useTranslateDataGridColumns("settings")}
				</Accordion.Control>
				<Accordion.Panel>
					<JsonInput
			...
			<Accordion.Item value="user">
				<Accordion.Control>
					{useTranslateDataGridColumns("user")}
				</Accordion.Control>
				<Accordion.Panel>
					<JsonInput
			...
			<Accordion.Item value="live_scraper">
				<Accordion.Control>
					{useTranslateDataGridColumns("live_scraper")}
				</Accordion.Control>
				<Accordion.Panel>
					<JsonInput
			...
			<Accordion.Item value="wfm_state">
				<Accordion.Control>
					{useTranslateDataGridColumns("wfm_state")}
				</Accordion.Control>
				<Accordion.Panel>
					<Group>
					...
					<Grid>
						<Grid.Col span={6}>
							...
							<JsonInput
								value={JSON.stringify(
									wfmState?.user_orders.buy_orders || {},
									null,
									2,
								)}
								validationError="Invalid JSON"
						...
						<Grid.Col span={6}>
							...
							<JsonInput
								value={JSON.stringify(
									wfmState?.user_orders.sell_orders || {},
									null,
									2,
								)}
								validationError="Invalid JSON"
			...
			<Accordion.Item value="tauri_events">
				<Accordion.Control>
					{useTranslateDataGridColumns("tauri_events")}
				</Accordion.Control>
				<Accordion.Panel>
					<DataTable
						records={tauriEvents}
