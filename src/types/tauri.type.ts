...
export namespace TauriTypes {
	...
	export interface ChartMultipleDto
		extends ChartWithMultipleValuesDto,
			ChartWithLabelsDto {}
	...
	export interface TransactionSummaryWithChartDto
		extends TransactionSummaryDto {
	...
	export interface CreateWishListItem
		extends Omit<CreateStockItem, "bought" | "minimum_price"> {
		maximum_price?: number;
	}
